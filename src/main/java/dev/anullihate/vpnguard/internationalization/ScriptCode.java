...
public enum ScriptCode {
        ...
        if (code == null) {
            ...
            switch(code.length()) {
                ...
                case 9:
                    ...
                    try {
                        return (ScriptCode)Enum.valueOf(ScriptCode.class, code);
    ...
    public static ScriptCode getByCode(int code) {
        return code <= 0 ? null : (ScriptCode)numericMap.get(code);
    }
    ...
    public static List<ScriptCode> findByName(Pattern pattern) {
        if (pattern == null) {
            ...
            ScriptCode[] var2 = values();
            int var3 = var2.length;

            for(int var4 = 0; var4 < var3; ++var4) {
                ScriptCode entry = var2[var4];
    ...
    static {
        ScriptCode[] var0 = values();
        int var1 = var0.length;

        for(int var2 = 0; var2 < var1; ++var2) {
            ScriptCode sc = var0[var2];
            if (sc.getNumeric() != -1) {
