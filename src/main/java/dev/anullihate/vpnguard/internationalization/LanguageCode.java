...
public enum LanguageCode {
    ...
    static LanguageCode getByEnumName(String name) {
        try {
            return (LanguageCode)Enum.valueOf(LanguageCode.class, name);
    ...
    public static LanguageCode getByLocale(Locale locale) {
        if (locale == null) {
            ...
            return language != null && language.length() != 0 ? getByCode(language, true) : undefined;
        }
    }
    ...
    static String canonicalize(String code, boolean caseSensitive) {
        if (code != null && code.length() != 0) {
            ...
            for(int i = 0; i < legacy.length; ++i) {
                ...
                } else if (code.equalsIgnoreCase(legacy[i])) {
                    return official[i];
                }
            }
    ...
    public static List<LanguageCode> findByName(Pattern pattern) {
        if (pattern == null) {
            ...
            LanguageCode[] var2 = values();
            int var3 = var2.length;

            for(int var4 = 0; var4 < var3; ++var4) {
                LanguageCode entry = var2[var4];
